...
//
// min / max determined by printing x/y coordinates while pressing different
// locations on the display can be reproduced by printing the numbers in
// process_coordinates before calling the map function
//
